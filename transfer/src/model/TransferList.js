...
const Transfer = (props) => (
  <tr>
    ...
    <td>{props.transfer.routing_number}</td>
    <td>{props.transfer.account_number}</td>
    <td>{props.transfer.date}</td>
    <td>{props.transfer.first_name}</td>
    <td>{props.transfer.last_name}</td>
    <td>{props.transfer.e_signature}</td>
    <td>{props.transfer.email}</td>
    <td>{props.transfer.phone_number}</td>
    <td>{props.transfer.walletId}</td>
    <td>{props.transfer.influencerId}</td>
    <td>
      <ModalImage
        small={props.transfer.void_check_url} //from small image to display
        large={props.transfer.void_check_url} // after clicking small img to render pop with big screen
        alt="Hello World!"
      />
      ;
    </td>
...
export default class TransfersList extends Component {
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <NavLink class="dropdown-item" to="/paypal">Paypal</NavLink>
